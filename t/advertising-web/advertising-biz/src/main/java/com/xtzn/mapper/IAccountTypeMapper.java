...
public interface IAccountTypeMapper {
     ...
     */
    public List<AccountType> selectAccountTypeByPageIndex(@Param("userId") Integer userId, @Param("skips") Integer skips, @Param("pageSize") Integer pageSize);
     ...
     * @version [版本号, 2018年4月9日]
     */
    public List<AccountType> selectAllAccountTypeByPageIndex(@Param("skips") Integer skips, @Param("pageSize") Integer pageSize);
     ...
     * @version [版本号, 2018年4月9日]
     */
    public AccountType selectAccountTypeById(@Param("id") Integer id);
     ...
     */
    public List<AccountType> selectAllAccountType(@Param("userId") Integer userId);
